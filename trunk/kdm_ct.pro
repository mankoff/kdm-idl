; $Id: myct.pro,v 1.1 2009/01/30 08:10:56 mankoff Exp mankoff $
;
; $Author: mankoff $
; $Revision: 1.1 $
; $Date: 2009/01/30 08:10:56 $
;
;+
; NAME:
;	SNOECT
...
;-
PRO kdm_ct, rr, gg, bb, $       ; old vectors to save
...
if not n_elements(gray) eq 0 then gray=1
...
if keyword_set(segs) then begin
   r[1:254] = congrid( congrid(r[1:254],segs), 254 )
   g[1:254] = congrid( congrid(g[1:254],segs), 254 )
   b[1:254] = congrid( congrid(b[1:254],segs), 254 )
endif
...
;
; $Log: myct.pro,v $
; Revision 1.1  2009/01/30 08:10:56  mankoff
; Initial revision
;
